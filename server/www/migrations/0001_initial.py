...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='metadata',
            name='applied',
            field=models.ManyToManyField(to='www.AppliedMetadata'),
        ),
        migrations.AddField(
            model_name='metadata',
            name='details',
        ...
        migrations.AddField(
            model_name='appliedmetadata',
            name='sample_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='www.Sample'),
        ),
        migrations.AddField(
            model_name='appliedmetadata',
            name='user_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='www.User'),
        ),
        migrations.AlterIndexTogether(
            name='sample',
        ...
        migrations.AlterUniqueTogether(
            name='appliedmetadata',
            unique_together=set([('metadata_id', 'sample_id', 'user_id')]),
        ),
    ]
